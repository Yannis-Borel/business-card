        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <!-- Main Blog Post -->
                                ...
                                <div class="kt-article-categories">
                                    <span><i class="icon_comment_alt"> </i><?php comments_number( __('No Comments','business-card'), __('1 Comment','business-card'),__('% Comment' ,'business-card')); ?></span>
                ...
                <div id="kt-pagination">
                    <div class="alignleft">
                        <?php previous_posts_link(__( '&laquo; Newer posts', 'business-card')); ?>
                    </div>
                    <div class="alignright">
                        <?php next_posts_link(__( 'Older posts &raquo;', 'business-card')); ?>
                    </div>
                </div>
                </div>
                <!-- Sidebar -->
