<?php get_header(); ?>
<?php get_template_part('libs/breadcrumbs'); ?>
    <div class="kt-main" role="main">
        <div class="container">
            <div class="row">
                    ...
                    <div <?php post_class('kt-article');?>>
                        <div class="row">
                            ...
                            <!-- Main Blog Post -->
                                ...
                                <span><?php echo __('by','business-card'); ?> <?php echo get_the_author(); ?></span>
                                ...
                                <div class="kt-article-categories">
                                    ...
                                    <?php comments_number( __('No Comments','business-card'), __('1 Comment','business-card'),__('% Comment' ,'business-card')); ?>
                                    </span>
                ...
                <div class="alignleft"><?php previous_posts_link(__( '&laquo; Newer posts', 'business-card')); ?></div>
                <div class="alignright"><?php next_posts_link(__( 'Older posts &raquo;', 'business-card')); ?></div>
            </div>
                </div>
                <!-- Sidebar -->
                <div class="col-md-4">
